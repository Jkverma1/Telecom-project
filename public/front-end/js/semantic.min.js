            ...
            event: {
              field: {
                ...
                change: function (t) {
                  var n = e(this),
                    i = n.closest(g);
                  ("change" == x.on || (i.hasClass(T.error) && x.revalidate)) &&
            ...
            get: {
              ...
              prompt: function (e, t) {
                ...
                return (
                  ...
                  e.prompt ||
                    P.verbose("Using default validation prompt for type", s, a),
                  s
                );
              },
              settings: function () {
              ...
              field: function (t) {
                return (
                  ...
                  m.filter("#" + t).length > 0
                    ...
                    : m.filter('[name="' + t + '[]"]').length > 0
                    ? m.filter('[name="' + t + '[]"]')
                    : m.filter("[data-" + w.validate + '="' + t + '"]').length >
                      0
              ...
              field: function (e) {
                return (
                  ...
                  m.filter("#" + e).length > 0
                    ...
                    ? !0
                    : m.filter("[data-" + w.validate + '="' + e + '"]').length >
                      0
                    ? !0
                    : !1
                );
                  ...
                  m.animateChildren &&
                    (e.fn.transition !== i && C.transition("is supported")
                      ...
                      : o
                          .children()
                          .stop(!0, !0)
                          .animate({ opacity: 1 }, m.duration, f.resetOpacity)),
                ...
                for (
                  ...
                  for (o = e("<tr/>").appendTo(X), i = 0; R > i; i++, t++) {
                    ...
                    a.toggleClass(g.disabledCell, Z),
                      ...
                      T ||
                        A ||
                        a.toggleClass(g.todayCell, f.helper.dateEqual($, s, r)),
                      f.helper.dateEqual($, l, r) && f.set.focusDate($, !1, !1);
                  }
                if (m.today) {
              ...
              for (o = 0; o < p.length; o++) {
                ...
                if (!(y.length <= 0)) {
                  for (
                    ...
                    if (
                      ((x = x
                        .substring(0, Math.min(y.length, Math.min(x.length, 3)))
                        .toLowerCase()),
                      x === y)
                    ) {
                      u = a + 1;
            ...
            should: {
              allowCheck: function () {
                return f.is.determinate() &&
                  ...
                  ? (f.debug("Should not allow check, beforeChecked cancelled"),
                    !1)
                  : !0;
              },
          ...
          (w = {
            ...
            observeChanges: function () {
              "MutationObserver" in t &&
                ...
                w.has.menu() && C.observe(U[0], { childList: !0, subtree: !0 }),
                ...
                w.debug("Dropdown initialized on a select", t),
                  ...
                  L.parent(P.dropdown).length > 0
                    ...
                    : (w.debug("Creating entire dropdown from select"),
                      ...
                      L.prop("disabled") &&
                        (w.debug("Disabling dropdown"), I.addClass(T.disabled)),
            ...
            event: {
              ...
              input: function (e) {
                (w.is.multiple() || w.is.searchSelection()) && w.set.filtered(),
            ...
            add: {
              ...
              variables: function (e, t) {
                ...
                return (
                  ...
                  r && ((i = t || w.get.query()), (e = e.replace("{term}", i))),
                  e
                );
              },
            ...
            remove: {
              ...
              value: function (e, t, n) {
                var i,
                  o = w.get.values();
                w.has.selectInput()
                  ? (w.verbose("Input is <select> removing selected option", e),
            ...
            get: {
                ...
                return (
                  ...
                  (a.target.margin.left = x.inline
                    ? y.is.rtl()
                      ...
                      : parseInt(
                          t.getComputedStyle(i).getPropertyValue("margin-left"),
                          10
                        )
                    : 0),
                  (e = a.screen),
              ...
              nextPosition: function (e) {
                ...
                return (
                  ...
                  (l || c) && (y.debug("Using backup position", u), (u = r[e])),
                  u
                );
              },
            },
            set: {
              position: function (e, t) {
                ...
                if (
                  ...
                  return y.debug("Popup target is hidden, no action taken"), !1;
                switch (
                  (x.inline &&
            ...
            increment: function (e) {
              ...
              f.has.total()
                ? ((n = f.get.value()),
                  ...
                  i > t &&
                    (f.debug("Value cannot increment above total", t), (i = t)))
                : ((n = f.get.percent()),
              ...
              return (
                i || o
                  ? (g.maxResults > 0 &&
                    ...
                    e.isFunction(n) ? (a = n(t, b)) : m.error(x.noTemplate, !1))
            ...
            stage: {
              above: function () {
                ...
                g.verbose(
                  ...
                  T.css({ transform: "translateZ(-" + e.depth.active + "px)" }),
                  t.css({
                    transform:
              ...
              left: function () {
                ...
                g.verbose(
                  ...
                  T.css({ transform: "translateZ(-" + n.depth.active + "px)" }),
                  t.css({
                    transform:
          ...
          (w = {
            ...
            show: function (t) {
              if (((t = e.isFunction(t) ? t : function () {}), w.is.hidden())) {
                if (
                  (w.refreshSidebars(),
                  k.overlay && (w.error(R.overlay), (k.transition = "overlay")),
                  w.refresh(),
                  w.othersActive())
                )
                  if (
      ...
      return (
        a.each(function () {
          ...
          (g = {
            ...
            bind: {
              events: function () {
                w.on("load" + y, g.event.load).on("resize" + y, g.event.resize),
                  k
                    .off("scroll" + y)
            ...
            unfix: function () {
              g.is.fixed() &&
                ...
                g.remove.offset(),
                C.removeClass(h.fixed).removeClass(h.top).removeClass(h.bottom),
                p.onUnstick.call(A));
            },
            reset: function () {
          ...
          (C = {
            ...
            force: {
              visible: function () {
                var e = w.attr("style"),
                  ...
                  r = e === i || "" === e;
                a !== n
                  ? (C.verbose("Overriding default display to show element", n),
                    w.attr("style", o))
            ...
            get: {
              ...
              userStyle: function (e) {
                return (
                  (e = e || w.attr("style") || ""), e.replace(/display.*?;/, "")
                );
              },
              ...
              state: function () {
                ...
                if (n.allows("active") && n.is.enabled()) {
                  if ((n.refresh(), e.fn.api !== i))
                    if (
                      ((t = C.api("get request")), (o = C.api("was cancelled")))
                    )
            ...
            topVisible: function (e) {
              ...
              return (
                e &&
                  ...
                  (p.onTopVisible = e)),
                t.topVisible ? g.execute(n, o) : p.once || g.remove.occurred(o),
